...
export default function ReplyBox({ initial }: { initial?: string }) {
  ...
  return (
    ...
    >
      <label className="block text-sm text-rose-900/70">If you want, you can type a reply here 😊</label>
      <textarea
        value={value}
      ...
      <div className="mt-3 flex justify-end">
        <button onClick={submit} disabled={loading || !value.trim()} className="btn-primary disabled:opacity-60">
